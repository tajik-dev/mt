<?php
$UI->pos['main'].='<h1>Ҳисобот оид ба китобҳои дарсӣ ва бадеии муассисаҳои таҳcилоти умумӣ</h1>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                <label for="nohiya" class="col-sm-3 control-label">Ноҳия (шаҳр)</label>

                <div class="col-sm-9">
                    <select id="nohiya" name="nohiya" class="form-control">
                        <option>--Интихоб намоед--</option>
                        <option>Нохия 1</option>
                        <option>Нохия 2</option>
                        <option>Нохия 3</option>
                        <option>Нохия 4</option>
                        <option>Нохия 5</option>
                    </select>
                </div>
            </div>
